...
namespace BuildXL.Execution.Analyzer
{
    internal partial class Args
    {
        public Analyzer InitializeFingerprintStoreAnalyzer(AnalysisInput oldAnalysisInput, AnalysisInput newAnalysisInput)
        {
            ...
            bool noBanner = false;
            long sshValue = -1;
            CacheMissDiffFormat cacheMissDiffFormat = CacheMissDiffFormat.JsonDiff;
            ...
            foreach (var opt in AnalyzerOptions)
            {
                ...
                else if (opt.Name.Equals("diffFormat", StringComparison.OrdinalIgnoreCase))
                {
        ...
        private static void WriteFingerprintStoreAnalyzerHelp(HelpWriter writer)
        {
            ...
            writer.WriteOption("diffFormat", "Optional. Diff format. Allowed values are JsonDiff and JsonPatchDiff. Defaults to JsonDiff");
        }
    }
    ...
    internal class FingerprintStoreAnalyzer : Analyzer
    {
        ...
        /// Diff format.
        /// </summary>
        public CacheMissDiffFormat CacheMissDiffFormat = CacheMissDiffFormat.JsonDiff;
